...
public class ArduinoNodeMCU extends EmbeddedSystem {

	public ArduinoNodeMCU(String name, jfml_iot.communication.Communication communication) {
		super(name, communication);
	}

	public ArduinoNodeMCU(String name, ArrayList<Device> devices,
